...
from app.api.v1.endpoints import evaluations, health, assignment_eval
...
api_router.include_router(assignment_eval.router, prefix="/assignment-eval", tags=["assignment-eval"])
